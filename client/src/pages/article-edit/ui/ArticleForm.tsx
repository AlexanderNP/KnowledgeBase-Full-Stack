...
type ArticleForm<T extends "create" | "update"> = T extends "create"
  ? ReturnType<typeof useCreateArticle> & { type: T }
  : ReturnType<typeof useUpdateArticle> & { type: T };

export const ArticleForm = <T extends "create" | "update">({
  Field,
  Subscribe,
  handleSubmit,
  type,
